...
Podfile.prototype.getTemplate = function () {
    ...
    return util.format(
        '# DO NOT MODIFY -- auto-generated by Apache Cordova\n' +
            ...
            '%s\n' +
            'end\n'+
            // We need to propagate our minimum develpoment target in all the pods, ref: https://github.com/CocoaPods/CocoaPods/issues/4859
            ...
            '  end\n' +
            'end\n',
        this.sourceToken, this.minDeploymentTarget, this.declarationToken, projectName, projectName, this.podToken, this.minDeploymentTarget);
};
